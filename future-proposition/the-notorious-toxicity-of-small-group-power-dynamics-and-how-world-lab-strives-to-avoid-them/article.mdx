---
title: >-
  The notorious toxicity of small group power dynamics and how World Lab strives
  to avoid them
---
...
- Does not assign malicious intent (unless provable). See [Halons Razor](https://en.wikipedia.org/wiki/Hanlon%27s_razor).
...
**In World Lab**By giving everyone a voice in decisions and by talking things through with the community we can create a culture of general accountability and decision-making rooted in collective agency.
