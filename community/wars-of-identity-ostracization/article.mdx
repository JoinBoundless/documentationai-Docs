...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>
    <strong>Tip:</strong> The best possible thing to do in such cases is to not respond. Resist the desire to help. Counseling people on the internet often confirms a person's own problematic biases as one has no way of getting further context of an individual's life online.
  </p>
</div>
