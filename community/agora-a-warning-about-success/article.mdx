...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>
    <span>Consider that many of the largest communities in the world, like Facebook or Twitter/X, are not actually communities at all. And that there are very few places where there are millions of people sharing the same identity, congregating online in a meaningful way.</span>
    <span>The reason is, online, keeping deep communities together is actually profoundly difficult.</span>
  </p>
</div>
...
<div
  ...
  <p
    ...
    <a
      ...
      style={{ textDecoration: "none", color: "#8d9de0" }}>
      See Part 2
    </a> to learn what to expect in the latter days.
  </p>
</div>
