...
<div
  ...
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>
    Consider that many of the largest communities in the world, like Facebook or Twitter/X, are not actually communities at all. And that there are very few places where there are millions of people sharing the same identity, congregating online in a meaningful way. The reason is, online, keeping deep communities together is actually profoundly difficult.
  </p>
</div>