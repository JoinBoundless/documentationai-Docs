...
<p
  ...
  color: "#bbf7d0",
  fontSize: "14px",
    }}>Key takeaway:</strong>By nature, creating a community necessitates either correcting or excluding those who defy its core values.
</p>
</div>
...
- (2) A means of codifying values and lessons learned. 
  ...
  - **Trade-off:** <span style={{
  color: "#1cd496",
    }}>Superstition could limit</span> what a society could learn academically.
