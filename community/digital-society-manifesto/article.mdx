...
>
  ...
  >
    <span>Online Safety Act being used to censor protests</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
...
<p style={{ fontSize: "14px", whiteSpace: "nowrap" }}> <a href="https://freespeechunion.org/archive/protest-footage-blocked-as-online-safety-act-comes-into-force" target="_blank" rel="noopener noreferrer" style={{ color: "#3b82f6",textDecoration: "none" }} >Protest footage blocked</a>{" "}as online safety act comes into force. </p>
</div>
</details>
