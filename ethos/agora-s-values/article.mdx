...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>
  Victorious warriors <strong>win first</strong> and then go to war, while
...
>
  <p style={{ margin: 0 }}>
    The excellent put time, effort, and thought into excellence before they
    come to any task. The defeated seek the results of the victorious without
    the necessary preparation, serving only to highlight the value of proper
    habits.
  </p>
</div>
</details>
