...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#c4a214" }}>
<strong style={{ fontSize: "14px", lineHeight: "1.6", color: "#c4a214" }}> Disclaimer: Self improvement must be self directed</strong>\
\
