...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6C84A" }}>
<strong style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6C84A" }}> Disclaimer: Self improvement must be self directed</strong>\
\
