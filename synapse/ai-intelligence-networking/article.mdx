...
9. Clear descriptions of each option for AI navigation.</p>
  </div>
</details>
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
    style={{
  ...
  >
    <span>AI ideas that were viable</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
  ...
  <p>Time Zone Awareness: A simple sun/moon icon next to friends' names to show if it's day or night for them, preventing accidental late-night pings.
