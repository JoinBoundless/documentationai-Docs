...
>  <summary
  ...
  <p>Those who are not developers or designers should skip this.
<br /><br />
...
Clear descriptions of each option for AI navigation.</p>
  </div>
</details>
<details
  open
...
>  <summary
  ...
  <p>1. **Time Zone Awareness:** A simple sun/moon icon next to friends' names to show if it's day or night for them, preventing accidental late-night pings.
