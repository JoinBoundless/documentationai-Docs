...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
 ...
 <p>All these different features require certain things from every single developer. This is an attempt to bring those together, at least for this article.</p>
<p>1. 2D icon
2. Building look
3. Application distribution company
4. Default permissions when collaborators are dropped in
5. Application description (high + low level category)
6. Veterancy rules
7. Rank system edits
8. AI permissions
9. AI navigation descriptions  </p>
  </div>
</details>
<div
  style={{
...
>
  ...
  </p><li><strong>Concept</strong> The AI can identify when a series of individual questions or problems are coalescing into a topic worthy of a larger, live discussion.</li>
  ...
  </p><li><strong>Concept</strong> The "Ghost" replay feature shows what someone did. The AI can use this to find perfect collaborators.</li>
