...
<Callout kind="tip">
  This article is a chapter in a larger book. 
    [Start reading here »](https://agora.joinboundless.org/synapse/the-design-of-synapse)
</Callout>
...
<Expandable title="Designer tips">
...
<Expandable title="A list of things developers need to add to every application.">
...
<Expandable title="Information transmission in the medieval period">
<p>Those who are not developers or designers should skip this.</p>
