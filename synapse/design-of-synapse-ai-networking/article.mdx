...
<Accordion title="A list of things developers need to add to every application.">
...
<Accordion title="Information transmission in the medieval period">
<p>Those who are not developers or designers should skip this.</p>
