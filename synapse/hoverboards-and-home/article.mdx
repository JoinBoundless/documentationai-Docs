...
<details open style={{ borderRadius: "12px", marginTop: "16px", border: "1px solid #3a3f47", overflow: "hidden", background: "#44403C" }}>
  ...
  >
    <p>These teleports are like city teleports in that they are a proxy of the original item and are one and the same with the original item on the shelf. They are represented in purple like all teleports.</p>
