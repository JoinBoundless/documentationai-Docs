...
>  <summary
  ...
  <p>These teleports are like city teleports in that they are a proxy of the original item and are one and the same with the original item on the shelf. They are represented in purple like all teleports.
