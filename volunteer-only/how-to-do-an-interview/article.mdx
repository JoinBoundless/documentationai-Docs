...
- Make sure to have read the <a href="https://articles.joinboundless.org/vision">
Boundless vision
...
"This has been awesome, I would love to set up our next chat at (specify time using <a href="https://worldlab.joinboundless.org/tools/default-tools#timezone-tools">
hammertime
</a> ), shall we meet then? We need a 2 hour slot for the next one."

If yes: 

"Next time we'll be going over our mission and volunteer expectations, if you can please read this document in detail and prepare some questions. <a href="https://articles.joinboundless.org/vision">
