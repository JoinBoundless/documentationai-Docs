...
<div
  ...
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}><strong style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}> "This is not a place for pessimists, naysayers, and gatekeepers, but visionaries trying to change the world."</strong>"What we expect of people here is an attitude of trying new things and pushing boundaries for the sake of impact."</p>
</div>