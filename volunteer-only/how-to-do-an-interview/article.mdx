...
- "Here is what you need to know, let's go through it together: 
 ...
 <a href="https://worldlab.joinboundless.org/start-here/becoming-a-volunteer-for-boundless#our-method" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
<div
  ...
  <p>"What we expect of people here is an attitude of trying new things and pushing boundaries for the sake of impact."</p>
</div>