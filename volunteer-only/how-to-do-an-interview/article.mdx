...
- Make sure to have read the <a href="https://articles.joinboundless.org/vision" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
...
Boundless vision
</a> at least once before. You don't have to be an expert in it's contents. 
...
"This has been awesome, I would love to set up our next chat at (specify time using <a href="https://worldlab.joinboundless.org/tools/default-tools#timezone-tools" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
hammertime
</a> ), shall we meet then? We need a 2 hour slot for the next one."

If yes: 

"Next time we'll be going over our mission and volunteer expectations, if you can please read this document in detail and prepare some questions. <a href="https://articles.joinboundless.org/vision" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
https\://articles.joinboundless.org/vision
</a> "
...
<a
    href="https://worldlab.joinboundless.org/start-here/becoming-a-volunteer-for-boundless#our-method"
    target="_blank"
  ...
  >https\://worldlab.joinboundless.org/start-here/becoming-a-volunteer-for-boundless#our-method</a>
...
<div
  ...
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}>Explain that world lab is both used to train people and develop real apps. There is no division.</p>
</div>
...
<Image src="https://cdn.eniston.com/bases/5ba25e36-2715-44ac-b4f3-9b9cf9081634/attachments/gbneafn-1-_1744497034.png?width=920" width="458" height="166" alt='If you click the "invite" button in Discord' />
...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>Once you've done this a few times, you'll find it's more efficient to check if teams are available beforehand and to guide them on the path of making their own team from the get-go if not.</p>
</div>
<div
  style={{
    marginTop: "24px",
  ...
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}><strong style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}> "This is not a place for pessimists, naysayers, and gatekeepers, but visionaries trying to change the world."</strong></p>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}>"What we expect of people here is an attitude of trying new things and pushing boundaries for the sake of impact."</p>
</div>