...
<div
  ...
  <div
    style={{
      ...
      whiteSpace: "nowrap",
      overflow: "hidden",
      textOverflow: "ellipsis", // 👈 optional but nice
      display: "block",
      width: "100%"
    }}>
    “
    ...
    ” is a prerequisite that should be read first.
  </div>
</div>
<div
  style={{
...
>
  <p style={{ color: "#bbf7d0", fontSize: "14px" }}>
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      style={{ textDecoration: "underline", color: "#8d9de0" }}
    >
...
<details
  ...
  style={{
    ...
    overflow: "hidden",
    background: "#2F2E2E" // match content background
  }}
>
  <summary
    style={{
      background: "#BDBBB8", // ✅ top part
