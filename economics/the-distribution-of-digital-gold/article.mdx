...
>
  ...
  <p>
    <ul><li style={{ fontSize: "14px", lineHeight: "1.6", color: "#ba9a13" }}>The problem is that even though we want to discover only legitimate transactions, AI will be so human in the future that we can't distinguish between AI and humans. And AI can become compliant to a Ponzi scheme.</li></ul>
</p>
