...
<Accordion title="Why does the amount of money need to match economic activity?">
...
<Accordion title="Validating transactions">
...
<Accordion title="Reputation events">
...
<Accordion title="Other reputational factors">
