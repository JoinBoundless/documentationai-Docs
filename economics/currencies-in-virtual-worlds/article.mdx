...
<Callout kind="info">
  This article contains a large amount of thoughts on a potential Synapse currency. It should be seen merely as a brainstorm. Synapse needs to prepare for the eventuality of currency in its system, something that has 
    [ruined similar systems](https://agora.joinboundless.org/economics/ideal-foundations-of-digital-societies)
</Callout>
...
Unfortunately, this same principle could draw speculators to the system if not prevented. <a href="https://agora.joinboundless.org/economics/ideal-foundations-of-digital-societies">
...
<Expandable title="The current exception">
<p>
