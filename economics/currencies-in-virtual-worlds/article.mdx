...
<div
  ...
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>This article contains a large amount of thoughts on a potential Synapse currency. It should be seen merely as a brainstorm. Synapse needs to prepare for the eventuality of currency in its system, something that has [ruined similar systems](https://agora.joinboundless.org/economics/ideal-foundations-of-digital-societies).</p>
</div>
