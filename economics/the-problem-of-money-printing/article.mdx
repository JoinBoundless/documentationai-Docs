...
<details
  ...
  <p style={{ margin: 0 }}>
    ...
    <p>Namely, the government buys the right to print money from banks. Meaning that in a debt-based system, these banks profit enormously.</p>
  </div>
</details>
