...
1. Restrictions on currency exchange speed.

   1. Restrictions on the speed at which currency can be exchanged for the society's currency and vice versa may lead to a less emotionally driven system.

2. Currency unbound from society

   1. A currency tied to more than one digital society, but active in an entire Accord, is more likely to hold its value, especially if the new society in question is part of or becomes part of the same Accord.

3. Universal currency.

   1. A currency for all digital societies may be created.
