...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <p>Digital societies are not allowed to create contracts which lock people into a digital society, and since such a thing could be considered a contract lock-in, this must be noted to be explicitly legal, since the one third loss is considered sufficient.</p>
  </div>
</details>
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <p>For every 10,000 citizens they have, they can seize all of the vaults of five citizens per month.</p>
  </div>
</details>
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <p>It is illegal for a digital society to change the terms after the vault is sealed or to impose other taxes on those who interact with vaults.</p>
  </div>
</details>
