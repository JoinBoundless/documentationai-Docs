...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;">
  <summary style="background:#44403C; color:#ffffff; padding:14px 18px; cursor:pointer; font-size:14px; font-weight:500; display:flex; justify-content:space-between; align-items:center;">
    <span>How real-world ID led to greater control in China</span>
    <span style="opacity:0.7;">⌃</span>
  </summary>

  <div style="background:#3a3531; padding:14px 18px; font-size:14px; color:#E7E5E4; line-height:1.6; border-top:1px solid #5a544f; display:flex; flex-direction:column; gap:12px;">
