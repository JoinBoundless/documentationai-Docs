...
<Accordion title="Optional deep dive with examples">
...
<Accordion title="AI stuff that was helpful:">
...
<Accordion title="Full technical breakdown">
### Real representation
...
<Accordion title="How real-world ID led to greater control in China">
