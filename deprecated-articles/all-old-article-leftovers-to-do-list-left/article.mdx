...
<Expandable title="Optional deep dive with examples">
...
<Expandable title="AI stuff that was helpful:">
...
<Expandable title="Full technical breakdown">
### Real representation
...
<Callout kind="tip">
  Next, read our 
    [Principles of Life](https://agora.joinboundless.org/ethos/principles-of-life) to learn how we define "victory within".
</Callout>
...
<Callout kind="tip">
  Read about 
    [Agoran values here >>](https://agora.joinboundless.org/ethos/agoran-beliefs) .
</Callout>
...
<Callout kind="tip">
  Continue to Agora's 
    [Principles of Action >>](https://agora.joinboundless.org/ethos/agora-s-values)
</Callout>


<Expandable title="* SLAPP,**License">
...
<Expandable title="How real-world ID led to greater control in China">
