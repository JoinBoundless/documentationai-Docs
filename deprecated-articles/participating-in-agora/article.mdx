...
<span style={{ color: "#51c490" }}>Warning: this is now out of date.</span>The projects we work on at Agora can be broken up into 5 parts:
...
* (b) <a href="https://agora.joinboundless.org/future-proposition/creating-social-apps" style={{ color: "#3b82f6", textDecoration: "none" }}>Social apps >></a>
