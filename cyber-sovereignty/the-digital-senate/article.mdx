...
A digital society which is convicted in a national court for failing its <a href="https://agora.joinboundless.org/cyber-sovereignty/further-checks-and-balances" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
...
</a> can be penalized by the Digital Senate but only if the following provisions are met.
...
2. The changes do not violate the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-core-rejections-of-cyber-sovereignty" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
The Digital Senate has the right to prosecute fraudulent manipulation within Synapse, as{" "}
<a
  href="https://agora.joinboundless.org/economics/possible-concepts-for-the-virtual-economy"
  style={{
    color: "#3b82f6",
