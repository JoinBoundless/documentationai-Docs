...
<Expandable title="Overlap: Accords">
...
<Expandable title="Corporate citizenship analysis">
...
<Callout kind="tip">
  Learn about 
      [Continue to "What is a digital society?" >>](https://agora.joinboundless.org/cyber-sovereignty/creating-a-digital-society)
</Callout>

<Expandable title="\*, ❋, ‡, ⊛, §,◊ specific legal details">
