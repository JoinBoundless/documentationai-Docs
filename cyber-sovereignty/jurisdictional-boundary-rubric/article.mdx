...
>
  <p style={{ marginTop: 0 }}>
    2. Does it have irreversible second-order effects that are <em>very likely</em> to cause catastrophic harm outside the digital society?
  </p>

  <p>
    3. Does it absolutely require national organization to have effect?
  </p>
  ...
  <p>
    5. Does it subject non-consenting individuals to catastrophic physical harm?
  </p>
