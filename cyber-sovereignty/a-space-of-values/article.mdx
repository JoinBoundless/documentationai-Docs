...
>
  <h3 style={{ color: "#bbf7d0", fontSize: "16px", margin: 0 }}>
    Overview complete
  </h3>

  <p style={{ color: "#bbf7d0", fontSize: "14px", marginTop: "8px" }}>
    There are no more articles within this overview. If you'd like to continue reading about Cyber Sovereignty, we suggest reading the{" "}
    <a
    ...
    >
      Cyber Sovereignty Charter next.
    </a>
  </p>
</div>
