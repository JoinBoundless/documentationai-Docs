...
1. Do the defense and prosecution have the equivalent amount of time to adjudicate the case in question?

   1. Does either party have disproportionate access to resources or tools?

2. Does the court in question have a significant number of individuals that have been convicted and later acquitted revealing a pattern of false convictions?

   1. Does the court and system of justice it depends on allow for reasonable investigation into the possibility of false convictions including the right of discovery?

3. Does the court have a documented pattern of unpunished misconduct?

   1. Does each element of power have an equal and opposite element of balance that frequently holds to account any party involved in the justice system that engages in misconduct? Do these elements fraternize with those that they should hold accountable?

4. Is there information asymmetry between the prosecution and defense?

   1. Is the defense provided any and all evidence equivalent to that which is provided the prosecution before the evidence is examined by any party to ensure the prosecutor doesn't hide evidence?

      1. Are there frequent complaints by defense attorneys of relevant evidence not being provided?

   2. Are there significant safeguards preventing evidence tampering by the accusing party?
...
10. Are the indictments made where one party (e.g. the prosecutor) has more leverage than the other?

    1. Are innocent people regularly indicted?
...
2. Hand over all potential evidence to both the defense and prosecution before review of the material by the other party.

   1. Governments may use a system in which a third party equally filters that information for classified information removing it totally from both parties.
