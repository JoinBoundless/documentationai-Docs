...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>Such communities will be considered <strong>single-facet societies</strong>in future texts, remember this.</p>
</div>
