...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>A thesis like this explains the reasoning by which this provision was created but is not part of the legal provision itself. It helps interpret the provision.</p>
</div>
