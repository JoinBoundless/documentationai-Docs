...
1. Does national organization of the matter infringe on the deeply held values of multiple communities within the nation?
...
<Expandable title="Genetic regulation">
### Genetic regulation
...
<Expandable title="Animal protection">
### Animal protection&#xA0;
...
<Expandable title="Pandemic response">
### Pandemic response
...
<Expandable title="Banking regulation">
### Banking regulation
...
<Expandable title="Similar rubric questions which were rejected">
...
<Expandable title="Example scenarios">
