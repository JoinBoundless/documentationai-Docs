...
>
  <p style={{ marginTop: 0 }}>
    ...
    If any parties engage in commerce of over 2.5 million annually, and both of the following factors are determined by a judge in one of the parties' digital jurisdictions, then the jurisdiction in question may be overturned:
  </p>

  <ul style={{ paddingLeft: "28px", marginBottom: 0 }}>
    <li>
      The digital society's power and control is not truly in the hands of its citizens and their chosen constitution.
    </li>
    <li>
