...
<div
  style={{
    ...
    lineHeight: '1.6',
    color: '#eaeaea'
  }}>A digital society's laws govern all activity on its platforms when the first-order effects of the digital platform are contained digitally and within that digital society's platform(s).</div>
