...
>
  <strong style={{ fontWeight: 600 }}>Golden Law</strong>{' '}- Everyone can create, copy, choose from, abstain from, or transfer between digital societies, without hindrance, coercion or penalty from any physical or digital authority. ⊛
</div>
...
To prevent abuse,{" "}
<a
  href="https://agora.joinboundless.org/cyber-sovereignty/what-demands-national-organization"
  style={{
    color: "#3b82f6",
...
<a
  ...
  style={{
    ...
    textDecoration: "none",
    display: "inline"
  }}>tribunal</a>{" "}exist to decide what requires national organization.
...
<p
  ...
  >Continue to "What is a digital society?" >></a>
</p>
</div>
...
>
  ...
  >
    <p style={{ margin: 0 }}>
      Disclaimers and legal notes are found{" "}
      
      <a
        href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty"
        style={{
          color: "#3b82f6",
          WebkitTextFillColor: "#3b82f6",
          textDecoration: "none",
