...
>
  ...
  >
    <p style={{ margin: 0 }}>
      A <a
        href="https://agora.joinboundless.org/cyber-sovereignty/corporate-citizenship"
        target="_blank"
        rel="noopener noreferrer"
        style={{
          color: "#3b82f6",
        ...
        future article
      </a> covers how corporations interact with digital societies. An exception includes the <a
        href="https://agora.joinboundless.org/cyber-sovereignty/what-demands-national-organization"
        target="_blank"
        rel="noopener noreferrer"
        style={{
...
>
  ...
  >
    ...
    >
      <span>Disclaimers and legal notes are found</span>
