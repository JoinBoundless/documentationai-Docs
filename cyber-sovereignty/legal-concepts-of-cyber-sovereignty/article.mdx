...
To prevent abuse, [a rubric](https://agora.joinboundless.org/cyber-sovereignty/what-demands-national-organization) and [tribunal](https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel) exist to decide what requires national organization.
...
A [future article](https://agora.joinboundless.org/cyber-sovereignty/corporate-citizenship) covers how corporations interact with digital societies. An exception includes the [Visitor's jurisdiction](https://agora.joinboundless.org/cyber-sovereignty/what-demands-national-organization).
