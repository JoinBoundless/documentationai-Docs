...
When a digital society or an Accord feels that the <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" target="_blank" rel="noopener noreferrer">Charter</a> rights of its citizens is being violated by their national government, the digital society can organize to defend its citizens.  \
  \
...
Any matter of jurisdiction or rights can be appealed to the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">Jurisdictional Boundary Tribunal</a> (JBT) if that tribunal accepts the case. 
...
The government can protect people within it's nation via its own bill of rights or by the rights granted in the <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" target="_blank" rel="noopener noreferrer">Charter</a> but must not overwrite digital society laws using this shield. 
...
However, if it wanted to take money out of their national bank account, it would need to be in compliance with the full <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" target="_blank" rel="noopener noreferrer">Charter</a> and with the individual's national bill of rights or charter and the national government would have the discretion to enforce the judgement or not. To be clear, the digital society would not need to comply with national *regulations* to do so. It would simply need to comply with *rights* granted to individuals in that nation by law.

So, for example, if a digital society allowed people to make sports bets, but the national government did not, and the digital society implemented a judgment in which a contractual sports bet must be paid by an individual who took a bet, the national government should comply because betting is neither a violation of the rights of any party of individuals under the <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" target="_blank" rel="noopener noreferrer">Charter</a> or most national governments.
...
The ultimate court of appeals for all such cases is the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">Jurisdictional Boundary Tribunal (JBT)</a>.
...
Here is a full article on <a href="https://agora.joinboundless.org/cyber-sovereignty/further-checks-and-balances" target="_blank" rel="noopener noreferrer">how this system works</a> and all the checks and balances in it. 

## **The power of Accords**

Digital societies have the right to delegate some or all of their rights to Accords provided:

1. Each digital society does not have a different legal delegation level to the Accord.

2. Digital societies consent, at least annually, to this delegation with no coercive mechanisms used on the digital society.

3. Those that manage the Accord consent.
...
1. Losing access to the society's private platforms and forums.

2. Losing any specific status, rank, or title held within the society.

3. Losing access to services and benefits provided exclusively to citizens (e.g., welfare, insurance).

4. Being removed from any elected or appointed positions held within the society.

5. Losing access to Accord-based benefits that relied on your citizenship.

6. The society requiring you to send your declaration to them via a preset form provided that form requires you to agree to nothing else but the retention of the data submitted including anything that verifies your citizenship. 

7. The society retaining your public contributions to its platforms (e.g., forum posts, open-source code).

8. Having to sell any society-specific assets that are legally restricted to citizens only provided <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" target="_blank" rel="noopener noreferrer">real consent</a> was obtained before the purchase of those assets. 

9. Losing voting rights in the society's governance.

10. Friends within the society choosing, of their own free will, to no longer associate with you.

11. Being required to return any physical or digital property belonging to the society.

12. The society publishing your departure.

13. Losing access to a shared community treasury or resource pool.

14. Being asked to participate in a voluntary exit interview to provide feedback.

15. The society ceasing to act as your legal defender against your national government.
...
1. Imposing a financial "exit fee" or "departure tax" or similar. 

2. Threatening to release personal confidential information about the person leaving.

3. Forcing remaining family members to "disconnect" from a person. 

4. Stopping one from taking out assets because one is leaving. 

5. Using a previously signed contract to legally prevent one from leaving for a set time.

6. Freezing or seizing personal assets that are not subject to a pre-existing legal judgment.

7. Threatening one with legal action for the act of leaving itself.

8. Declaring pre-existing contracts with other members null and void for those who depart. 

9. Demanding the repayment of benefits received (e.g., education, welfare).

10. Creating negative implications for those associated with a person purely for them leaving.

11. Filing frivolous lawsuits against a person in other jurisdictions to create legal costs.

12. Using your departure as a reason to deny services to your remaining associates. 

13. Creating unreasonable friction in the transfer of money or financial assets that other citizens can easily remove from the society because one left the society.

14. Attempts to stop one joining other societies once one leaves. This does not include publishing a general negative review of a person, but it does include reaching out to other societies to tell them about a particular individual.
...
1. Does the difference in the implementation of Cyber Sovereignty within this nation differ from the original intent of Cyber Sovereignty or its ubiquitous practice throughout the world?

2. Do the changes made to the concept of Cyber Sovereignty create a significant obligation on digital societies if more or all nations were to implement similar obligations?
...
2\) Direct first-order effects are the only matters that count, not ricochet effects "victim by ricochet" or similar like those recognized in courts today. There is one exception to this rule listed <a href="https://agora.joinboundless.org/cyber-sovereignty/weaknesses-of-cyber-sovereignty" target="_blank" rel="noopener noreferrer">here</a>.
...
1. Is the product or service primarily used by a society's citizens?

2. If it's being used by non-members are effective measures being used to stop non-members using it? 

3. Does it create an exploitative workaround to national laws?

4. Is it crystal clear that it cannot be used outside of the digital society or by non-members?

5. Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).
...
If it does not agree, then the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">standard panel process</a> must be used to determine if that product or service has first order effects outside the digital society based on the above rubric. 
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Defamation-as-a-service*** **The product**: A digital society hosts a service that uses AI to generate hyper-realistic "deepfake" videos of public figures saying inflammatory and false things.

* **The shield**: The society’s terms of service explicitly state, "These videos are for satirical entertainment within our society only. Publishing them on external platforms is a violation of our law."

* **The problem**: A user generates a deepfake of a CEO making racist remarks and posts it on a major social media platform. The company's stock plummets, and the CEO's reputation is destroyed. The digital society claims the "first-order effect" was contained because the harm only occurred when a user broke their rules by exporting the video.                                                                                                                                                                                                                                             | - Is the product or service primarily used by a society's citizens?

  - Yes, it's primarily being used by its citizens only. 

    - Effect contained? +1

- If it's being used by non-members are effective measures being used to stop non-members using it?

  - No, there's a lack of effective measures here.

    - Effect contained? 0

- Does it create an exploitative workaround to national laws?

  - Yes, the national government outlawed such videos. 

    - Effect contained? -1

- Is it crystal clear that it cannot be used outside of the digital society or by non-members?

  - Yes, the terms of service say it explicitly.
...
- Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).
  ...
  - No.
    ...
    - Effect contained? +1In this case, the rubric determines that the effects are contained within the society.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Unlicensed medical advice AI**- **The product**: A society develops an AI that provides detailed medical diagnoses and prescribes treatments, without any clinical trials, licensing, or oversight.

- **The shield**: The platform has a clear disclaimer: "This AI is an educational tool for our citizens. Following its advice for real-world medical treatment is prohibited and done at your own risk."

- **The problem**: A member shares a transcript of the AI's advice with a family member outside the society. That person follows the dangerous advice and suffers severe physical harm. The society argues its product was only "educational" and the harm was caused by the illegal act of applying it as real medical advice.                                                                                                                                                                                                                                                                      | * Is the product or service primarily used by a society's citizens?
...
* Does it create an exploitative workaround to national laws?
  ...
  - Yes, the national government outlawed such unlicensed advice.
...
* Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).
  ...
  - No.
    ...
    - Effect contained? +1In this case, the rubric determines that the effects are contained within the society.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Ransomware development kits*** **The product**: A corporation within a digital society sells a sophisticated "cybersecurity testing toolkit" which is, in reality, a user-friendly ransomware creation kit.

* **The shield**: The license agreement states, "This software is to be used exclusively for testing the security of networks owned by the user within this society. Deploying it against external targets is a crime under our laws."

* **The problem**: A user buys the kit and launches a ransomware attack against a hospital's network, crippling its systems. The society claims no responsibility, as the first-order effect of selling a "testing tool" was contained; the external harm was caused by the user's criminal misuse.                                                                                                                                                                                                                                                            | - Is the product or service primarily used by a society's citizens?
...
- Does it create an exploitative workaround to national laws?
  ...
  - Yes, the national government outlawed such tools.
...
* Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).
  ...
  - No.
    ...
    - Effect contained? -1In this case, the rubric determines the effects are not contained in the society due to the widespread use and distribution outside the society.                                                                                                                                                                                                                                                                                                                                                                                                      |
...
★ Once a digital society accepts a case, it is presumed to have that jurisdiction and right. It's reasonable for national governments to require individuals to sign a document stating that they agree to a longer pre-trial detention in order to receive digital jurisdiction, provided it's a maximum of 72 hours longer than the maximum pre-trial detention allowed by that state. If the other jurisdiction would like the case, they may begin the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">standard panel process</a>. 
...
The party that feels the case is in the wrong jurisdiction, be it a government or society has the right to trigger the upcoming process. If the party in question is an individual then they should sue in the jurisdiction where they desire the case to be moved to and the suit will trigger the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">standard panel process</a>. 
...
Once an individual joins a digital society that has made its <a href="https://agora.joinboundless.org/cyber-sovereignty/creating-a-digital-society" target="_blank" rel="noopener noreferrer">declaration of sovereignty</a>, then that digital society must issue the individual in question a certificate declaring the individual in question is citizen. The certificate would include a with a date and/or may use a cryptographically signed version of the same. Both the digital society and individual would keep a copy.
...
<a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">Standard panel process.</a> 
...
1. The digital society allows the creation of legal shields, namely, fictitious legal entities like corporations charities or nonprofits which absolve individuals from legal liability. Anything that operates like a modern corporation or nonprofit counts.

2. The digital society acts as the arm of a corporation.

3. The digital society is used by corporations to create subsidiaries that work through particular individuals rather than corporations themselves.

4. The digital society's laws provide built-in legal liability protections to individuals that would normally be reserved for corporations.

5. Particular individuals within the digital society are operating at a scale that would be reserved for large businesses under most national governments.
...
1. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#how-digital-societies-intervene-for-their-citizens" target="_blank" rel="noopener noreferrer">How digital societies intervene for their citizens</a>

2. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#why-national-governments-must-intervene" target="_blank" rel="noopener noreferrer">Why national governments must intervene</a>

   1. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#1-consent" target="_blank" rel="noopener noreferrer">(1) Consent</a>

   2. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#2-exceptional-power" target="_blank" rel="noopener noreferrer">(2) Exceptional power</a>

3. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#how-national-governments-intervene" target="_blank" rel="noopener noreferrer">How national governments intervene</a>

4. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#protected-from-all-sides" target="_blank" rel="noopener noreferrer">Protected from all sides</a>

5. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#reporting-nesting-and-transparency" target="_blank" rel="noopener noreferrer">Reporting, nesting, and transparency</a>

6. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#the-power-of-accords" target="_blank" rel="noopener noreferrer">The power of Accords</a>

7. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#how-digital-precedence-works" target="_blank" rel="noopener noreferrer">How digital precedence works</a>

8. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#the-golden-law-detailed" target="_blank" rel="noopener noreferrer">The Golden Law (detailed)⊛</a>

9. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#law-of-precedence" target="_blank" rel="noopener noreferrer">Law of precedence</a>

10. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#fixing-ballooning-deficits" target="_blank" rel="noopener noreferrer">Fixing ballooning deficits</a>

11. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#international-similarity-the-sacred-provision" target="_blank" rel="noopener noreferrer">International similarity: The sacred provision</a>

12. <a href="https://agora.joinboundless.org/cyber-sovereignty/legal-mechanisms-of-cyber-sovereignty#where-digital-societies-stop-being-digital" target="_blank" rel="noopener noreferrer">Where digital societies stop being digital</a>
