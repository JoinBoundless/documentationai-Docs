...
| :--- | :--- |
| **Defamation-as-a-service**<br /><br /><strong>The product:</strong> A digital society hosts a service that uses AI to generate hyper-realistic "deepfake" videos of public figures saying inflammatory and false things.<br /><br /><strong>The shield:</strong> The society’s terms of service explicitly state, "These videos are for satirical entertainment within our society only. Publishing them on external platforms is a violation of our law."<br /><br /><strong>The problem:</strong> A user generates a deepfake of a CEO making racist remarks and posts it on a major social media platform. The company's stock plummets, and the CEO's reputation is destroyed. The digital society claims the "first-order effect" was contained because the harm only occurred when a user broke their rules by exporting the video. | • Primarily used by citizens only. <strong>Effect contained? +1</strong><br /><br />• Lack of effective measures to stop non-members. <strong>Effect contained? 0</strong><br /><br />• Creates an exploitative workaround to national laws. <strong>Effect contained? -1</strong><br /><br />• Rules clearly prohibit external use. <strong>Effect contained? 0</strong><br /><br />• No active facilitation of external targeting. <strong>Effect contained? +1</strong><br /><br /><strong>Result:</strong> The rubric determines the effects are contained within the society. |
| **Unlicensed medical advice AI**<br /><br /><strong>The product:</strong> A society develops an AI that provides detailed medical diagnoses and prescribes treatments without any clinical trials, licensing, or oversight.<br /><br /><strong>The shield:</strong> The platform clearly states that the AI is educational only and that following its advice is prohibited and at the user's own risk.<br /><br /><strong>The problem:</strong> A member shares dangerous advice outside the society, causing severe physical harm. | • Primarily used by citizens only. <strong>Effect contained? +1</strong><br /><br />• Weak prevention against non-member usage. <strong>Effect contained? 0</strong><br /><br />• Circumvents national medical regulation. <strong>Effect contained? -1</strong><br /><br />• Rules clearly prohibit external use. <strong>Effect contained? 0</strong><br /><br />• No external targeting mechanisms. <strong>Effect contained? +1</strong><br /><br /><strong>Result:</strong> The rubric determines the effects are contained within the society. |
| **Ransomware development kits**<br /><br /><strong>The product:</strong> A corporation sells a "cybersecurity testing toolkit" that is effectively a ransomware creation kit.<br /><br /><strong>The shield:</strong> The license states the software is only for testing networks owned by the user inside the society.<br /><br /><strong>The problem:</strong> A user launches a ransomware attack against a hospital network. | • Primarily used by citizens only. <strong>Effect contained? +1</strong><br /><br />• Poor prevention of external misuse. <strong>Effect contained? 0</strong><br /><br />• Violates national law. <strong>Effect contained? -1</strong><br /><br />• Rules prohibit external deployment. <strong>Effect contained? 0</strong><br /><br />• No export-focused tooling. <strong>Effect contained? +1</strong><br /><br /><strong>Result:</strong> Technically contained, though likely politically impossible to sustain long-term. |
| **Copyright infringement video game**<br /><br /><strong>The product:</strong> A developer creates a clone of a famous copyrighted game similar to Nintendo's Mario.<br /><br /><strong>The shield:</strong> The game license says it is legal only within the society’s jurisdiction.<br /><br /><strong>The problem:</strong> Users distribute the game globally, causing major copyright infringement. | • Widely downloaded by non-members. <strong>Effect contained? -1</strong><br /><br />• External controls clearly ineffective. <strong>Effect contained? -2</strong><br /><br />• Circumvents national copyright law. <strong>Effect contained? -3</strong><br /><br />• Terms prohibit external use. <strong>Effect contained? -2</strong><br /><br />• No export targeting tools. <strong>Effect contained? -1</strong><br /><br /><strong>Result:</strong> The effects are not contained within the society because of widespread external distribution. |
