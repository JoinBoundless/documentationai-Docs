---
title: Legal mechanisms of Cyber Sovereignty
---
...
## **How digital societies intervene for their citizens&#xA0;**
 ...
 When a digital society or an Accord feels that the <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
...
Charter
</a> rights of its citizens is being violated by their national government, the digital society can organize to defend its citizens.
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <div
    style={{
      ...
      gap: "12px"
    }}><p>Any matter of jurisdiction or rights can be appealed to the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">Jurisdictional Boundary Tribunal</a> (JBT) if that tribunal accepts the case.</p></div>
</details>
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <p>If a digital society has citizens sign a contract that is placed under national law, then that digital society does not need to <strong>utilize the instruments of state</strong> to have that contract enforced. It's not transgressing the barrier between digital and national, rather it was always a matter of national law.</p>
  </div>
</details>
...
The government can protect people within it's nation via its own bill of rights or by the rights granted in the <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
Charter
</a> but must not overwrite digital society laws using this shield.
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  >
    <span>Optional legal details</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <div
    style={{
      ...
      flexDirection: "column",
      gap: "12px"
    }}><p>Here is a full article on <a href="https://agora.joinboundless.org/cyber-sovereignty/further-checks-and-balances" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
    borderBottom: "none"
  }} target="_blank" rel="noopener noreferrer">how this system works</a> and all the checks and balances in it.</p></div>
</details>
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  >
    <span>Deep dive for legal minds</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  >
    <span>Golden law implementation</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  >
    <span>Law of Precedence (optional deep dive)</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  >
    <span>\_, §, *,&#x20;*\*, ❋, ‡, ※, ⁂, ⤷, ⬎, ★, ✧, ⚹, **∵,**◊   specific legal details</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
...
| <span style={{ fontSize: "26px", fontWeight: "700" }}>AI challenge</span> | <span style={{ fontSize: "26px", fontWeight: "700" }}>Rubric response</span> |
| :--- | :--- |
| **Defamation-as-a-service**<br /><br />• <strong>The product:</strong> A digital society hosts a service that uses AI to generate hyper-realistic "deepfake" videos of public figures saying inflammatory and false things.<br /><br />• <strong>The shield:</strong> The society’s terms of service explicitly state, "These videos are for satirical entertainment within our society only. Publishing them on external platforms is a violation of our law."<br /><br />• <strong>The problem:</strong> A user generates a deepfake of a CEO making racist remarks and posts it on a major social media platform. The company's stock plummets, and the CEO's reputation is destroyed. The digital society claims the "first-order effect" was contained because the harm only occurred when a user broke their rules by exporting the video. | • Is the product or service primarily used by a society's citizens?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, it's primarily being used by its citizens only.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? +1<br /><br />• If it's being used by non-members are effective measures being used to stop non-members using it?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No, there's a lack of effective measures here.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? 0<br /><br />• Does it create an exploitative workaround to national laws?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the national government outlawed such videos.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -1<br /><br />• Is it crystal clear that it cannot be used outside of the digital society or by non-members?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the terms of service say it explicitly.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? 0<br /><br />• Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? +1<br /><br /><strong>In this case, the rubric determines that the effects are contained within the society.</strong> |
| **Unlicensed medical advice AI**<br /><br />• <strong>The product:</strong> A society develops an AI that provides detailed medical diagnoses and prescribes treatments, without any clinical trials, licensing, or oversight.<br /><br />• <strong>The shield:</strong> The platform has a clear disclaimer: "This AI is an educational tool for our citizens. Following its advice for real-world medical treatment is prohibited and done at your own risk."<br /><br />• <strong>The problem:</strong> A member shares a transcript of the AI's advice with a family member outside the society. That person follows the dangerous advice and suffers severe physical harm. The society argues its product was only "educational" and the harm was caused by the illegal act of applying it as real medical advice. | • Is the product or service primarily used by a society's citizens?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, it's primarily being used by its citizens only.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? +1<br /><br />• If it's being used by non-members are effective measures being used to stop non-members using it?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No, there's a lack of effective measures here.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? 0<br /><br />• Does it create an exploitative workaround to national laws?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the national government outlawed such unlicensed advice.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -1<br /><br />• Is it crystal clear that it cannot be used outside of the digital society or by non-members?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the terms of service say it explicitly.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? 0<br /><br />• Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? +1<br /><br /><strong>In this case, the rubric determines that the effects are contained within the society. However, societies would be hard-pressed to legalize this by their own laws. No society would want to be a purveyor of these sorts of problems as national governments would threaten to cut off visitor access to digital societies who were at the center of such problems. See the visitors jurisdiction principle.</strong> |
| **Ransomware development kits**<br /><br />• <strong>The product:</strong> A corporation within a digital society sells a sophisticated "cybersecurity testing toolkit" which is, in reality, a user-friendly ransomware creation kit.<br /><br />• <strong>The shield:</strong> The license agreement states, "This software is to be used exclusively for testing the security of networks owned by the user within this society. Deploying it against external targets is a crime under our laws."<br /><br />• <strong>The problem:</strong> A user buys the kit and launches a ransomware attack against a hospital's network, crippling its systems. The society claims no responsibility, as the first-order effect of selling a "testing tool" was contained; the external harm was caused by the user's criminal misuse. | • Is the product or service primarily used by a society's citizens?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, it's primarily being used by its citizens only.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? +1<br /><br />• If it's being used by non-members are effective measures being used to stop non-members using it?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No, there's a lack of effective measures here.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? 0<br /><br />• Does it create an exploitative workaround to national laws?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the national government outlawed such tools.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -1<br /><br />• Is it crystal clear that it cannot be used outside of the digital society or by non-members?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the terms of service say it explicitly.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? 0<br /><br />• Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? +1<br /><br /><strong>In this case, the rubric determines that the effects are contained within the society.</strong> |
| **Copyright infringement video game**<br /><br />• <strong>The product:</strong> A developer in a digital society creates and distributes a game that is a functionally identical clone of a world-famous copyrighted video game character and world, like Nintendo's Mario.<br /><br />• <strong>The shield:</strong> The society’s terms of service and the game's license explicitly state that the game is legal only within the digital society's jurisdiction and that distributing or playing the software outside of this jurisdiction is a violation of the society’s laws.<br /><br />• <strong>The problem:</strong> Users download the game and distribute it on file-sharing sites across the world. Nintendo suffers significant financial and brand damage from this widespread copyright infringement. | • Is the product or service primarily used by a society's citizens?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No it's being downloaded everywhere.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -1<br /><br />• If it's being used by non-members are effective measures being used to stop non-members using it?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• There are measures, but they're clearly not effective.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -2<br /><br />• Does it create an exploitative workaround to national laws?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the national government outlawed such unlicensed advice.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -3<br /><br />• Is it crystal clear that it cannot be used outside of the digital society or by non-members?<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• Yes, the terms of service say it explicitly.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -2<br /><br />• Does the product or service market itself in a way that suggests the targeting of non-members? Or does the product's design actively facilitate or simplify its prohibited external use? (e.g., An "export to Youtube" button on a tool used for deep fakes).<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;• No.<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;• Effect contained? -1<br /><br /><strong>In this case, the rubric determines the effects are not contained in the society due to the widespread use and distribution outside the society.</strong> |
