...
<table style={{ width: "100%", borderCollapse: "collapse" }}>
  ...
  <tbody>
    <tr>
      ...
      >
        <p><strong>Defamation-as-a-service</strong></p>
        <p>
          <strong>The product:</strong> A digital society hosts a service that
          uses AI to generate hyper-realistic "deepfake" videos of public
          figures saying inflammatory and false things.
        </p>
        <p>
          <strong>The shield:</strong> The society’s terms of service explicitly
          state, "These videos are for satirical entertainment within our
          society only. Publishing them on external platforms is a violation of
          our law."
        </p>
        <p>
          <strong>The problem:</strong> A user generates a deepfake of a CEO
          making racist remarks and posts it on a major social media platform.
          The company's stock plummets, and the CEO's reputation is destroyed.
          The digital society claims the "first-order effect" was contained
          because the harm only occurred when a user broke their rules by
          exporting the video.
        </p>
      </td>
      <td
      ...
      >
        <ul>
          <li>
            Primarily used by citizens only.
            <strong> Effect contained? +1</strong>
          </li>
          <li>
            Lack of effective measures to stop non-members.
            <strong> Effect contained? 0</strong>
          </li>
          <li>
            Creates an exploitative workaround to national laws.
            <strong> Effect contained? -1</strong>
          </li>
          <li>
            Terms clearly prohibit external use.
            <strong> Effect contained? 0</strong>
          </li>
          <li>
            No active facilitation of external targeting.
            <strong> Effect contained? +1</strong>
          </li>
        </ul>
        <p>
          <strong>
            Result: The rubric determines the effects are contained within the
            society.
          </strong>
        </p>
      </td>
    ...
    <tr>
      ...
      >
        <p><strong>Unlicensed medical advice AI</strong></p>
        <p>
          <strong>The product:</strong> A society develops an AI that provides
          detailed medical diagnoses and prescribes treatments without any
          clinical trials, licensing, or oversight.
        </p>
        <p>
          <strong>The shield:</strong> The platform clearly states that the AI
          is educational only and that following its advice is prohibited and at
          the user's own risk.
        </p>
        <p>
          <strong>The problem:</strong> A member shares dangerous advice outside
          the society, causing severe physical harm.
        </p>
      </td>
      <td
        style={{
      ...
      >
        <ul>
          ...
          <li>
            Weak prevention against non-member usage.
            <strong> Effect contained? 0</strong>
          </li>
          <li>
            Circumvents national medical regulation.
            <strong> Effect contained? -1</strong>
          </li>
          <li>
            Rules clearly prohibit external use.
            <strong> Effect contained? 0</strong>
          </li>
          <li>
            No external targeting mechanisms.
            <strong> Effect contained? +1</strong>
          </li>
        </ul>
        <p>
    ...
    <tr>
      ...
      >
        <p><strong>Ransomware development kits</strong></p>
        <p>
          <strong>The product:</strong> A corporation sells a "cybersecurity
          testing toolkit" that is effectively a ransomware creation kit.
        </p>
        <p>
          <strong>The shield:</strong> The license states the software is only
          for testing networks owned by the user inside the society.
        </p>
        <p>
          <strong>The problem:</strong> A user launches a ransomware attack
          against a hospital network.
        </p>
      </td>
      <td
        style={{
      ...
      >
        <ul>
          ...
          <li>
            Poor prevention of external misuse.
            <strong> Effect contained? 0</strong>
          </li>
          <li>
          ...
          <li>
            Rules prohibit external deployment.
            <strong> Effect contained? 0</strong>
          </li>
          <li>
            No export-focused tooling.
            <strong> Effect contained? +1</strong>
          </li>
        </ul>
        <p>
          <strong>
            Result: Technically contained, though likely politically impossible
    ...
    <tr>
      ...
      >
        <p><strong>Copyright infringement video game</strong></p>
        <p>
          <strong>The product:</strong> A developer creates a clone of a famous
          copyrighted game similar to Nintendo's Mario.
        </p>
        <p>
          <strong>The shield:</strong> The game license says it is legal only
          within the society’s jurisdiction.
        </p>
        <p>
          <strong>The problem:</strong> Users distribute the game globally,
          causing major copyright infringement.
        </p>
      </td>
      <td
        style={{
      ...
      >
        <ul>
          <li>
            Widely downloaded by non-members.
            <strong> Effect contained? -1</strong>
          </li>
          <li>
            External controls clearly ineffective.
            <strong> Effect contained? -2</strong>
          </li>
          <li>
            Circumvents national copyright law.
            <strong> Effect contained? -3</strong>
          </li>
          <li>
            Terms prohibit external use.
            <strong> Effect contained? -2</strong>
          </li>
          <li>
            No export targeting tools.
            <strong> Effect contained? -1</strong>
          </li>
        </ul>
        <p>
          <strong>
            Result: The effects are not contained within the society because of
            widespread external distribution.
          </strong>
        </p>
      </td>
    </tr>
