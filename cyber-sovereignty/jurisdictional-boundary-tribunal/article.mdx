...
<p>The tribunal will at all times be composed of an odd number of judges. Its composition must maintain an equal balance between judges whose initial nomination came from the national government and those whose initial nomination came from digital societies, with the exception of a single tie-breaking judge. The affiliation of this tie-breaking judge will alternate each time a new group of judges is brought on board to ensure no party holds a permanent advantage.</p>
...
<p>Digital societies are allowed to fund the tribunal if funding is undermined as a political tactic by national governments, even though late or unreasonably low pay is against the law.</p>
  </div>
