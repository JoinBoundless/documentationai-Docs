...
>
  ...
  <p style={{ margin: 0, fontSize: "22px", opacity: 0.8 }}>
    — John Adams
  </p>
</div>
...
<div
  ...
  <p style={{ marginTop: 0, marginBottom: "18px" }}>"we have to pass the bill so that you can find out what is in it..." - US politician</p>
</div>
...
<a
  ...
  style={{
    ...
    boxShadow: "none",
    borderBottom: "none"
  }}>disapprove</a>{" "}of how Congress operates. In Europe, trust in political parties and{" "}<a
