...
Under Cyber Sovereignty, both sub-national and national governments are required to subject themselves to an independent audit agency chosen by the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
...
JBT
</a> which demonstrates what percent of individuals incomes are being taxed and how that money is spent.
...
All cases which arise from taxation matters will be handled by the standard panel process and appeals shall go to the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
</a> (JBT). The final arbiter of these matters is the JBT.
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  >
    <span>Understanding the checks and balances</span>
    <span style={{ opacity: 0.7 }}>⌃</span>
  </summary>
  <div
    style={{
...
<details open style="border-radius:12px; margin-top:16px; border:1px solid #3a3f47; overflow:hidden; background:#44403C;"> <summary
  ...
  <p>Not going by the fact that it's a human right to benefit from one's own labor, the following is the rationale behind these limits.</p>
 <p>1) Government should never cost more than 40% of people's income. Any government that charges more than this is being rewarded for inefficiency.</p>
  <p>2) As people gain status in a society, they gain leverage as well. Creating a tax burden that is disproportionate creates an equal incentive to corrupt government by the same amount of money the individual is being taxed.</p>
  <p>Moreover, the rich have options, allowing them to find ways to break or get around a system, something they have done with almost flawless success throughout most of human history.</p>
  <p>Instead, coming up with a reasonable negotiation allows there to be more winners in a system.</p>
  </div>
</details>
