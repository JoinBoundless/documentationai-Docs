...
Under Cyber Sovereignty, both sub-national and national governments are required to subject themselves to an independent audit agency chosen by the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel" target="_blank" rel="noopener noreferrer">
JBT
...
All cases which arise from taxation matters will be handled by the standard panel process and appeals shall go to the <a href="https://agora.joinboundless.org/cyber-sovereignty/the-trusted-panel">
...
<Expandable title="Understanding the checks and balances">
