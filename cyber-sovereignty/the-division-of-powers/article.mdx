...
**Problem****Today's solution****Why it fails**Horror and pornography are easily accessible by childrenID verification on social media to prove users aren't minors.De-anonymizes all posts, and therefore chills free speech and protests.Spread of CSAM. (Child P).Requires scanning of all photos on all phones.Client-side scanning allows eavesdropping on end-to-end encryption.Proliferation of extremist and illegal content.The government imposes its own tailored view of extremism on social media.Penalizes “harmful” content, including protests.Misinformation spreads faster than truth.Government imposes its own view of the truth on social media.Companies pressure government to remove content deemed harmful to the company.When government decides:
...
There are no more articles within this overview. If you'd like to continue reading about Cyber Sovereignty, we suggest reading the [Cyber Sovereignty Charter](https://agora.joinboundless.org/cyber-sovereignty/charter) next.
