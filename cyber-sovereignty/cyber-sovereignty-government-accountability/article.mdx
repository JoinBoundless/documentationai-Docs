...
>
  <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#E6F0FF" }}>This article is the first in a group of articles dedicated to creating a brief overview of Cyber Sovereignty.</p>
</div>
...
A recent Princeton University study suggests those without money have absolutely no say, as opposed to those with money "…the average American appear(s) to have only a minuscule, near-zero, statistically non-significant impact upon public policy." - 2014 Princeton <a href="https://pnhp.org/news/gilens-and-page-average-citizens-have-little-impact-on-public-policy/" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
...
<div
  ...
  <p
    style={{
      ...
      marginTop: 0,
      marginBottom: "18px"
    }}>For a detailed breakdown, see the article <a
      href="https://agora.joinboundless.org/cyber-sovereignty/how-democracy-failed-society"
      style={{
        color: "#93C5FD",
        textDecoration: "underline",
        display: "inline"
      }}>“how money undermines democratic systems”</a> though readers may wish to remain here to preserve their train of thought.</p>
  <p
    style={{
      fontSize: "14px",
      lineHeight: "1.6",
    ...
    <a
      ...
      style={{
        ...
        textDecoration: "underline",
        display: "inline"
      }}>“Why direct democracy always fails”</a> is also a related article relevant to deep dives into the subject.
  </p>
</div>
...
1. Imposing a new <a href="https://agora.joinboundless.org/cyber-sovereignty/charter" style={{ 
    color: "#3b82f6",
    textDecoration: "none",
    backgroundImage: "none",
    boxShadow: "none",
...
Charter of Rights
</a> on national governments that blocks the myriad of methods used by those governments to undermine people’s rights.

   a. These rights outright ban most government surveillance excesses.

2. Enabling digital societies to come to the rescue of their own citizens when their rights are violated.

   a. Digital societies are granted the right to sue national governments on behalf of their citizens where national governments violate the Charter.
...
3. Delegating the majority of invasive government power to digital societies and establishing national governments as a neutral/free zone.
   ...
   a. Digital societies gain power over that which doesn't absolutely require national or subnational organization through a tribunal process.
...
>
  <p style={{ color: "#bbf7d0", fontSize: "14px" }}>
    <a
      href="https://agora.joinboundless.org/cyber-sovereignty/cyber-sovereignty-declaration" target="_blank" rel="noopener noreferrer"
      target="_blank"
